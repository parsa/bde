...
//
//: o For 'BSLS_REVIEW_SAFE', use 'BSLS_REVIEW_SAFE_IS_ACTIVE'.
//:
//: o For 'BSLS_REVIEW', use 'BSLS_REVIEW_IS_ACTIVE'.
//:
//: o For 'BSLS_REVIEW_OPT', use 'BSLS_REVIEW_OPT_IS_ACTIVE'.
//
...
// builds:
//: o When 'BSLS_REVIEW_SAFE' assertions are enabled in assert or review mode,
//:   the function will be compiled and invoked.
//: o When 'BSLS_REVIEW_VALIDATE_DISABLED_MACROS' is defined the function will
...
//:   used.
//: o When 'BSLS_REVIEW_SAFE' assertions are assumed the function will be
